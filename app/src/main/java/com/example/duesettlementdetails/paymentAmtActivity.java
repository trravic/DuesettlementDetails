...
public class paymentAmtActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payment_enter_amt);
    ...
    public void onClick(View view) {
        if (view == buttonPay) {
            ...
            Toast.makeText(this,"this is not working fine",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getPayment() {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(paymentAmount)), "USD", "Library fee",
        ...
        builder.setMessage("Are you sure want to exit while saving?").setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        paymentAmtActivity.this.finish();
                    }
                })
